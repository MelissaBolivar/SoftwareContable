...
import { CreateOrUpdateColaborador } from '../../../../shared/interfaces/CreateOrUpdateColaborador.interface';
...
@Component({
  ...
  styleUrl: './formulario-colaboradores.component.scss'
})
...
componentForm: FormGroup;
  ...
  private createParserFormData(): CreateOrUpdateColaborador{
    return {            
  ...
  private updateParserFormData():CreateOrUpdateColaborador{
    return {
      TerceroId: this.id,      
      TipoDocId: this.componentForm.value.tipoDocumentoId,
      NumeroDoc: this.componentForm.value.numeroDocumento,
