...
import { Comprobantecaja } from '../../interfaces/comprobantecaja';
import { CreateOrUpdateComprobanteCaja } from '../../interfaces/CreateOrUpdateComprobanteCaja.interface';
...
export class ComprobantecajaService {
   ...
   */
      public getList(): Observable<Comprobantecaja[]> {    
        const idTipoFactura=3;   
   ...
   */
  public getListWithFilter(data: FieldFilter[]): Observable<Comprobantecaja[]> {
    return this.httpService.doPost<FieldFilter[], Comprobantecaja[]>(
   ...
   */
  public create(createFactura: CreateOrUpdateComprobanteCaja): Observable<unknown> {
    return this.httpService.doPost<CreateOrUpdateComprobanteCaja, unknown>(
   ...
   */
  public update(updateFactura: CreateOrUpdateComprobanteCaja): Observable<unknown> {
    return this.httpService.doPut<CreateOrUpdateComprobanteCaja, unknown>(
      `${environment.endpoint_api_Factura}`,
      updateFactura
    );
  }
