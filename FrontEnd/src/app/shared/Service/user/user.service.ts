...
import { InformationUser, TipoIdentificacion } from '../../interfaces/InformationUser.interface';
...
export class UserService {
 constructor(private readonly httpService: HttpService) { }
  ...
  public getListTiposDocumentos(): Observable<TipoIdentificacion[]> {    
    return this.httpService.doGet(
      `${environment.endpoint_api_TipoIdentificacion}`, 
    );
  }
