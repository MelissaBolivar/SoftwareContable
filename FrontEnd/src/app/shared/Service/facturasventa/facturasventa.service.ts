...
import { FacturasVenta } from '../../interfaces/facturasventa.interface';
import { CreateOrUpdateFacturasVenta } from '../../interfaces/CreateOrUpdateFacturasVenta.interface';
...
export class FacturasVentaService {
   ...
   */
      public getList(): Observable<FacturasVenta[]> {    
   ...
   */
  public getListWithFilter(data: FieldFilter[]): Observable<FacturasVenta[]> {
    return this.httpService.doPost<FieldFilter[], FacturasVenta[]>(
   ...
   */
  public create(createFactura: CreateOrUpdateFacturasVenta): Observable<unknown> {
    return this.httpService.doPost<CreateOrUpdateFacturasVenta, unknown>(
   ...
   */
  public update(updateFactura: CreateOrUpdateFacturasVenta): Observable<unknown> {
    return this.httpService.doPut<CreateOrUpdateFacturasVenta, unknown>(
      `${environment.endpoint_api_Factura}`,
      updateFactura
    );
  }
