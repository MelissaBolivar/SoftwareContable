namespace Contable.Application.Dtos.Tercero
{
    public class UpdateTerceroDto
    {
        ...
        public required string TipoDocId { get; set; }  // puede ser cc - nit - pasaporte - CE - en lista desplegable para elegir.
        public required string TipoTerceroId { get; set; } // Proveedor - Clientes - Empleado, en lista desplegable para elegir.
